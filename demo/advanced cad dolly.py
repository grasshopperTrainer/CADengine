...
class MyWindow(Window):
    def __init__(self):
        ...
        ff.append_color_texture(ff.TXTR.TRGT.TWO_D, ff.TXTR.CLR_FRMT.RGBA.RGBA, lid=0)
        ff.append_color_texture(ff.TXTR.TRGT.TWO_D, ff.TXTR.CLR_FRMT.RGB.RGB, lid=1)
        ff.append_color_texture(ff.TXTR.TRGT.TWO_D, ff.TXTR.CLR_FRMT.RGBA.RGBA32F, lid=2)
    ...
    def draw(self):
        with self.devices.frames[0] as f:
            ...
            with self.devices.frames[1] as f:
                ...
                v = f.pick_pixel(tid=2, pos=self.devices.cursors[0].pos_local.astype(int), size=(1, 1))
